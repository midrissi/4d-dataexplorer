...
export function BottomDockPanel() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      <div className="flex shrink-0 items-center gap-0.5 border-border/70 border-b bg-linear-to-b from-muted/35 to-muted/10 px-1.5 pt-1">
        <Button
          size="xs"
          variant={tab === 'console' ? 'secondary' : 'ghost'}
          className={cn(
            'h-6 gap-1.5 rounded-b-none px-2 text-[11px] transition-colors',
