...
export function CreateEntityDialog({
  ...
  }, [open, initialData, defaultEditMode])
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="sm:max-w-2xl" onKeyDown={handleContentKeyDown}>
        <DialogHeader>
          <DialogTitle>
          ...
          <div className="flex gap-0.5 rounded-lg border p-0.5">
            <Button
              ...
              className={cn('flex flex-1 gap-1 py-1.5 text-xs', editMode === 'form' ? '' : '')}
            >
            ...
            <Button
              ...
              className={cn('flex flex-1 gap-1 py-1.5 text-xs', editMode === 'json' ? '' : '')}
            >
        ...
        {editMode === 'form' ? (
          ...
          <>
            <div className="rounded-lg pt-4 pb-1.5" style={{ height: '300px' }}>
              <CodeEditor
                value={jsonValue}
                onChange={(value) => {
                  setJsonValue(value)
