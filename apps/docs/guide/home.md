...
Two buttons at the top jump to frequent tasks:

- **Command Palette** — opens the palette (`⌘ P`)
- **Structure** — opens the structure graph (`⇧ ⌘ S`)

Open Home from the sidebar home button, the command palette (**Open Home**), or by closing all dataclass tabs.
